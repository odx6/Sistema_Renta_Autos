...
<body> 
    ...
    <header>
        ...
        <div class="option-place">
            ...
            <div class="item-option" title="Mi auto">
                <a href="reservado.php"><i class="fas fa-car"></i></a>
            </div>
        </div>
    </header>
    ...
    <div class="main-content">
        <div class="content-page">
            <div class="title-section">Lista de Automóviles</div>
    ...
    <div class="title-section">Ubicación</div>
    <div class="mapa">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d953.5449255793393!2d-96.72578313657824!3d17.06386045890075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c7223e51c0f6dd%3A0x48eb80237ad60781!2sAlamo%20Renta%20de%20Autos!5e0!3m2!1ses-419!2smx!4v1637752798729!5m2!1ses-419!2smx" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </div>
                ...
                success:function(data){
                    ...
                    for (var i = 0; i < data.datos.length; i++) {
                        ...
                        '<div class="product-box">'+
                            '<a href="automovil.php?p='+data.datos[i].nm+'">'+
                                '<div class="product">'+    
                                    '<img src="assets/autos/'+data.datos[i].imagen+'">'+
                                    '<div class="detail-title">'+data.datos[i].marca+'</div>'+
                                    '<div class="detail-model">'+data.datos[i].mo+'</div>'+
                                    '<div class="detail-placa">'+data.datos[i].nm+'</div>'+
                                    '<div class="detail-placa">'+data.datos[i].color+'</div>'+
                                    '<div class="detail-placa">'+data.datos[i].km+'</div>'+
                                    '<div class="detail-Description">'+data.datos[i].DESCR+'</div>'+
                                    '<div class="detail-status">'+data.datos[i].estado+'</div>'+
                                    '<div class="detail-status"> $'+data.datos[i].pr+'.00 </div>'+
                                '</div>'+
                            '</a>'+
                        '</div>';
                    }
